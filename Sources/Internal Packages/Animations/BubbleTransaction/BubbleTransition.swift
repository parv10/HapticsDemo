...
open class BubbleInteractiveTransition: UIPercentDrivenInteractiveTransition {
    ...
    {
        guard let controller = controller, let view = controller.view else
        {
            return
...
extension BubbleTransition: UIViewControllerAnimatedTransitioning {
    ...
    public func animateTransition(using transitionContext: UIViewControllerContextTransitioning)
    {
        ...
        if transitionMode == .present
        {
            ...
            let presentedControllerView = transitionContext.view(forKey: .to) ?? UIView()
        ...
        else
        {
            ...
            let returningControllerView = transitionContext.view(forKey: key) ?? UIView()
